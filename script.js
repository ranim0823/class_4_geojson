...
async function loadUniqueFoodRelatedTypes() {
    try {
        const response = await fetch('/class_3_nyc-restaurant-review-google-maps/unique_food_related_types.json');
...
async function loadRestaurantData() {
    try {
        const response = await fetch('/class_3_nyc-restaurant-review-google-maps/filtered_restaurants.json');
